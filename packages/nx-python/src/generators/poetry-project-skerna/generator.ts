...
import {minimalPythonVersionFromRange, pythonToInformalVersion} from '../../utils/versions';
...
function normalizeOptions(
    ...
    newOptions.pyprojectPythonDependencyInformalVersion = pythonToInformalVersion(
        minimalPythonVersionFromRange(newOptions.pyenvPythonVersion)
    )
...
function addFiles(tree: Tree, options: NormalizedSchema) {
    ...
    if (options.linter === 'ruff') {
        generateFiles(
            tree,
            path.join(__dirname, 'files', 'ruff'),
            options.projectRoot,
            templateOptions
        );
    }
