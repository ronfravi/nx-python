...
async function generator(host: Tree, options: Schema) {
  ...
  addProjectConfiguration(host, normalizedOptions.projectName, {
    ...
    targets: {
      docs: {
        executor: '@skerna/python:run-commands',
        options: {
      ...
      add: {
        executor: '@skerna/python:add',
        options: {},
      },
      update: {
        executor: '@skerna/python:update',
        options: {},
      },
      remove: {
        executor: '@skerna/python:remove',
        options: {},
      },
      build: {
      ...
      install: {
        executor: '@skerna/python:install',
        options: {
          silent: false,
          args: '',
